/* Clean Excel annotation tails, restore card icons, and fit the 1280x720 game board inside the viewport. */
(() => {
  ...
  function fitGameToViewport() {
    ...
    if (!shell) return;
    const horizontal = Math.max(0.1, (window.innerWidth - 12) / 1280);
    const vertical = Math.max(0.1, (window.innerHeight - 12) / 720);
